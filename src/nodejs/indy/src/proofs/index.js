...
exports.getProofRequests = async function(force) {
    if(force || !proofRequests) {
       ...
       // console.log("Vish2: GovID is : " + indy.did.getGovIdCredDefId())
        let govIDCredDef = await indy.issuer.getCredDefByTag('GOVID');
        if(govIDCredDef) {
           // console.log("Vish: GovID is " + govIDCredDef.id)
        }
        // let govIDCredDef = await indy.issuer.getCredDefByTag('GOVID');
        // if(govIDCredDef) {
        //     proofRequests['General-Identity'] = {
        ...
        //             'attr1_referent': {
        //                 'name': 'name',
        //                 'restrictions': [{'cred_def_id': govIDCredDef.id}]
        //             }
        //         },
        //         requested_predicates: {}
        //     }
        ...
        let greScoreCredDef = await indy.issuer.getCredDefByTag('MyGREScore');
        if(greScoreCredDef) {
